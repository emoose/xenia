...
XEPACKEDSTRUCT(XContentMetadata, {
  ...
  union {
    be<uint16_t> display_name_raw[9][128];
    char16_t display_name_chars[9][128];
  };
  union {
    be<uint16_t> description_raw[9][128];
    char16_t description_chars[9][128];
  };
  union {
  ...
  union {
    be<uint16_t> display_name_ex_raw[3][128];
    char16_t display_name_ex_chars[3][128];
  };
  uint8_t title_thumbnail[0x3D00];
  union {
    be<uint16_t> description_ex_raw[3][128];
  ...
  std::u16string display_name(XLanguage language) const {
    ...
    if (lang_id >= 0 && lang_id < 9) {
      ...
      str = display_name_ex_raw[lang_id - 9];
    }
  ...
  std::u16string description(XLanguage language) const {
    ...
    if (lang_id >= 0 && lang_id < 9) {
      ...
      str = description_ex_raw[lang_id - 9];
    }
  ...
  bool display_name(XLanguage language, const std::u16string_view value) {
    ...
    if (lang_id >= 0 && lang_id < 9) {
      ...
      str = display_name_ex_chars[lang_id - 9];
    }
    ...
    std::fill_n(str, 128, 0);
    string_util::copy_and_swap_truncating(str, value, 128);
    return true;
  }
  ...
  bool description(XLanguage language, const std::u16string_view value) {
    ...
    if (lang_id >= 0 && lang_id < 9) {
      ...
      str = description_ex_chars[lang_id - 9];
    }
  ...
  bool publisher(const std::u16string_view value) {
  ...
  bool title_name(const std::u16string_view value) {
